...
public class RequestAcceptResponseBoxPreviewFragment extends Fragment {
    private Box box;
    ...
    public RequestAcceptResponseBoxPreviewFragment() {
        // Required empty public constructor
    }


    public static RequestAcceptResponseBoxPreviewFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_request_accept_response_box_preview, container, false);

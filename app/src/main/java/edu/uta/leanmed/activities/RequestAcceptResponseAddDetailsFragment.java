...
public class RequestAcceptResponseAddDetailsFragment extends Fragment {
    ...
    public RequestAcceptResponseAddDetailsFragment() {
        // Required empty public constructor
    }


    public static RequestAcceptResponseAddDetailsFragment newInstance(String param1, String param2) {
        RequestAcceptResponseAddDetailsFragment fragment = new RequestAcceptResponseAddDetailsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_request_accept_response_add_details, container, false);
        this.initServices();
    ...
    private void setSubmitButton(View view) {
        ...
        buttonSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                BoxContent boxContent = this.getBoxContentObject();
                this.submitBoxContentToServer(boxContent);
            }
            ...
            private BoxContent getBoxContentObject() {
                request.setComments(comments);
                return new BoxContent(request.getInventory(), request, box.getBoxId(), request.getCreatedUser(), units);

            }

            private void submitBoxContentToServer(BoxContent boxContent) {
                Call<BoxResponse> boxResponseCall = boxAPIService.addNewBoxContent(user.getEmailId(), user.getToken(), boxContent);
